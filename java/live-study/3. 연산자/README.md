...
a
    ...
    000|00000000000000000000000000001|000   //빈 공간은 부호 비트인 0으로 채워짐
결과: 1

b
  <--|00000000000000000000000000000001|     //왼쪽으로 3칸 이동
 |00000000000000000000000000000001|000      //빈 공간은 부호 비트인 0으로 채워짐
결과: 8

c
    |11111111111111111111111110011100|->    //오른쪽으로 2칸 이동
    11|111111111111111111111111100111|00    //빈 공간은 부호 비트인 1로 채워짐
결과: -25

d
    |11111111111111111111111110011100|->    //오른쪽으로 2칸 이동
    00|111111111111111111111111100111|00    //빈 공간은 0으로 채워짐
결과: 1073741799
~~~

a, b, c는 모두 값에 해당하는 비트만 이동되고 부호 비트는 변경되지 않기 때문에 부호가 변경되지 않는다. 하지만 d는 원래 부호 비트가 1이었지만 0으로 무조건 채워지기 때문에 부호가 변경되게 된다.
